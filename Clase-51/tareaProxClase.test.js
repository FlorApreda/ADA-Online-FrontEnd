...
El hotel tiene 25 habitaciones y deberia tener 25 propiedades o indices, una por habitacion,
para guardar llaves. Cada una de estas propiedades deberia permitirme cambiar su estado 
de "llave guardada" a "llave entregada".
...
function Llavero() {
	...
	const buscarIndexHabitacion = (nroHabitacion) =>
		this.habitaciones.findIndex((h) => h.numero === nroHabitacion)
