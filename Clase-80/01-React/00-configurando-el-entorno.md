...
Esto va a permitir que podamos usar rutas absolutas y no relativas a la hora de importar archivos. En el archivo `.env`, _si estamos en Windows_ tenemos que colocar:

```text
SASS_PATH=./node_modules;./src
```

y si estamos en _Linux/Mac_,
